...
class M4KTableIndexView: UIView {
    ...
    func setup() {
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(indexViewWasTapped))
    ...
    func indexViewWasTapped(_ gesture: UIPanGestureRecognizer) {
